...
import 'package:simple_live_tv_app/services/soop_account_service.dart';
  ...
  Widget buildAccountSettings() {
    return ListView(
      ...
      children: [
        ...
        Obx(
          () => HighlightListTile(
            focusNode: controller.soopFoucsNode,
            autofocus: controller.soopFoucsNode.isFoucsed.value,
            title: "SOOP账号",
            subtitle: SoopAccountService.instance.hasCookie.value
                ? "已配置 Cookie（${SoopAccountService.instance.cookie.length} 字符）"
                : "未配置 Cookie",
            leading: Image.asset(
              "assets/images/soop.png",
              width: 64.w,
              height: 64.w,
            ),
            onTap: controller.soopTap,
          ),
        ),
      ],
    );
